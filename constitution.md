...
- ix. Loot obtained by the HL team in PvP event must be sent to distribution and logged with all jobs paid the at the same rate, based on time spent actively helping, as with all other logged work. In return Ships used by the HL team in PvP event will be refiled by distribution.
